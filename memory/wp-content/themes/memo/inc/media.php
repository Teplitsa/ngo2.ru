...
//add_filter('image_size_names_choose', 'memo_medialib_custom_image_sizes');
function memo_medialib_custom_image_sizes($sizes) {
 ...
 **/
add_filter('media_send_to_editor', 'memo_media_send_to_editor_filter', 2, 3);
function memo_media_send_to_editor_filter($html, $id, $attachment) {
