...
add_action('widgets_init', 'alv_custom_widgets', 11);
function alv_custom_widgets(){
	...
	//register_widget('ALV_RSS_Widget');
	//register_widget('ALV_Recent_Posts_Widget');
	//register_widget('ALV_Featured_Post_Widget');
	//register_widget('ALV_Social_Links');
...
class ALV_RSS_Widget extends WP_Widget {
    ...
    function widget($args, $instance) {
		...
		$link_txt = apply_filters('alv_the_title', $instance['link_txt']);
...
/** Recent Posts Widget **/
class ALV_Recent_Posts_Widget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		<div class="rpw-block<?php if($has_thumb) echo ' has-thumb';?>">
			...
			<?php
				...
				$sep = apply_filters('rpw_post_meta_separator', alv_get_sep(), $post);
...
/** Featured Post **/
class ALV_Featured_Post_Widget extends WP_Widget {
	...
	?>
		<div class="fw-item">
			...
			<div class="entry-summary"><?php echo apply_filters('alv_the_content', apl_get_excerpt_with_link($cpost));?></div>
		</div>
...
/** Social Links Widget **/
class ALV_Social_Links extends WP_Widget {
