...
//add_filter('image_size_names_choose', 'alv_medialib_custom_image_sizes');
function alv_medialib_custom_image_sizes($sizes) {
	
	$addsizes = apply_filters('alv_medialib_custom_image_sizes', array(
		"post-thumb" => __("Column-width", "alv")
	));	
 ...
 **/
add_filter('media_send_to_editor', 'alv_media_send_to_editor_filter', 2, 3);
function alv_media_send_to_editor_filter($html, $id, $attachment) {
