<div class="postbox" id="frm_comment_list">
    ...
    <div class="inside">
        ...
        <a href="#" class="button-secondary alignright frm_show_comment" data-frmtoggle="#frm_comment_form">+ <?php _e( 'Add Note/Comment', 'formidable' ) ?></a>
        <div class="clear"></div>

        <form name="frm_comment_form" id="frm_comment_form" method="post" class="frm_hidden">
