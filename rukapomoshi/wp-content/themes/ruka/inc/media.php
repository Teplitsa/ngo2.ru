...
//add_filter('image_size_names_choose', 'ruka_medialib_custom_image_sizes');
function ruka_medialib_custom_image_sizes($sizes) {
	
	$addsizes = apply_filters('ruka_medialib_custom_image_sizes', array(
 ...
 **/
add_filter('media_send_to_editor', 'ruka_media_send_to_editor_filter', 2, 3);
function ruka_media_send_to_editor_filter($html, $id, $attachment) {
