...
class BB_RSS_Widget extends WP_Widget {
    ...
    function widget($args, $instance) {
		...
		$link_txt = apply_filters('ruka_the_title', $instance['link_txt']);
...
class BB_Recent_Posts_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __('List of recent posts with some styling', 'ruka')
		);
		$this->WP_Widget('widget_posts_recent', __('Recent Posts', 'ruka'), $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		<div class="rpw-block<?php if($has_thumb) echo ' has-thumb';?>">
			...
			<?php
				...
				$sep = apply_filters('rpw_post_meta_separator', ruka_get_sep(), $post);
	...
	?>
		<div class="rpw-title">
			<a href="<?php the_permalink();?>" title="<?php printf(esc_attr__('Permalink to %s', 'ruka'), the_title_attribute('echo=0')); ?>" rel="bookmark"><?php the_title();?></a>
		</div>	
	<?php
	}
	...
	function form($instance) {
		...
		$thumb_sizes = array(
			'none'           => __('Don\'t show', 'ruka'),
			'thumbnail'      => __('Square thumbnail', 'ruka'),
			'post-thumbnail' => __('Landscape thumnbail', 'ruka')
		);
	?>
				
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title', 'ruka');?>:</label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo $title; ?>"/>
		</p>
			
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('limit')); ?>"><?php _e('Limit', 'ruka'); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('date')); ?>"><?php _e('Display Date?', 'ruka'); ?></label>
			<input id="<?php echo $this->get_field_id('date'); ?>" name="<?php echo $this->get_field_name('date'); ?>" type="checkbox" value="1" <?php checked('1', $date); ?> />&nbsp;
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('excerpt')); ?>"><?php _e('Display Excerpt?', 'ruka'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('length')); ?>"><?php _e('Excerpt Length', 'ruka'); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('thumb_size')); ?>"><?php _e('Thumbnail', 'ruka'); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('post_type'));?>"><?php _e('Choose the Post Type', 'ruka');?>:</label>

			<select class="widefat" id="<?php echo $this->get_field_id('post_type');?>" name="<?php echo $this->get_field_name('post_type');?>">
				<option value="0"><?php _e('Select post type', 'ruka');?></option>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('taxonomy'));?>"><?php _e('Choose the Taxonomy', 'ruka');?>:</label>

			<select class="widefat" id="<?php echo $this->get_field_id('taxonomy');?>" name="<?php echo $this->get_field_name('taxonomy');?>">
			<option value="0"><?php _e('Select taxonomy', 'ruka');?></option>
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'slug' ); ?>"><?php _e('Term slug', 'ruka'); ?>:</label>
		...
		<small class="help"><?php _e('Copy paste a slug (or comma-separated list of several slugs) of the term', 'ruka'); ?> </small>
		</p>
