...
$tst = __("Teplitsa of social technologies", 'ruka');
...
<footer id="colophon" class="site-footer" role="contentinfo"><div class="container">			
	<div class="frame">
		<div class="bit md-6">
			<div class="copy"><a href="<?php home_url();?>"><?php bloginfo('name');?>.<?php bloginfo('description');?></a>. <?php printf(__('All materials of the site are avaliabe under license %s.', 'ruka'), $cc_link);?>
			</div>
		</div>
