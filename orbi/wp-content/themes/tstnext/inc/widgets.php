...
class BB_Recent_Posts_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __('List of recent posts with some styling', 'tst')
		);
		$this->WP_Widget('widget_posts_recent', __('Recent Posts', 'tst'), $widget_ops);
	}
	...
	?>
		<div class="rpw-title">
			<a href="<?php the_permalink();?>" title="<?php printf(esc_attr__('Permalink to %s', 'tst'), the_title_attribute('echo=0')); ?>" rel="bookmark"><?php the_title();?></a>
		</div>	
	<?php
	}
	...
	function form($instance) {
		...
		$thumb_sizes = array(
			...
			'thumbnail'      => __('Square thumbnail', 'tst'),
			'post-thumbnail' => __('Landscape thumnbail', 'tst')
		);
	?>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('limit')); ?>"><?php _e('Limit', 'tst'); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('date')); ?>"><?php _e('Display Date?', 'tst'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('length')); ?>"><?php _e('Excerpt Length', 'tst'); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('thumb_size')); ?>"><?php _e('Thumbnail', 'tst'); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('post_type'));?>"><?php _e('Choose the Post Type', 'tst');?>:</label>

			<select class="widefat" id="<?php echo $this->get_field_id('post_type');?>" name="<?php echo $this->get_field_name('post_type');?>">
				<option value="0"><?php _e('Select post type', 'tst');?></option>
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'slug' ); ?>"><?php _e('Term slug', 'tst'); ?>:</label>
		...
		<small class="help"><?php _e('Copy paste a slug (or comma-separated list of several slugs) of the term', 'tst'); ?> </small>
		</p>
...
class BB_Social_Links extends WP_Widget {
    ...
    function __construct() {
        $this->WP_Widget('widget_socila_links', __('Social Buttons', 'tst'), array(
