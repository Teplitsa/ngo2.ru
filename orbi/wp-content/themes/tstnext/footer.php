...
<div id="bottombar" class="widget-area  "><div class="container">		
	...
	<div class="section grey-text text-lighten-5">
		<div class="row">
			
			<div class="col s12 l8">
				<div class="row">
					<div class="col s6"><?php dynamic_sidebar( 'footer_1-sidebar' );?></div>
					<div class="col s6"><?php dynamic_sidebar( 'footer_2-sidebar' );?></div>				
				</div>
			</div>
