...
//add_filter('image_size_names_choose', 'bb_medialib_custom_image_sizes');
function bb_medialib_custom_image_sizes($sizes) {
	
	$addsizes = apply_filters('bb_medialib_custom_image_sizes', array(
 ...
 **/
add_filter('media_send_to_editor', 'bb_media_send_to_editor_filter', 2, 3);
function bb_media_send_to_editor_filter($html, $id, $attachment) {
