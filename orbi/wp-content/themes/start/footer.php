...
$tst = __("Teplitsa of social technologies", 'bb');
...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">		
		<div class="frame">
			<div class="bit md-6">
				<div class="copy"><a href="<?php home_url();?>"><?php bloginfo('name');?></a>. <?php printf(__('All materials of the site are avaliabe under license %s.', 'bb'), $cc_link);?>
				</div>
			</div>
