...
<div id="page" class="hfeed site">
	<a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'step' ); ?></a>
	
	<nav id="langs_nav" class="langs-nav">
		<span class="screen-reader-text"><?php _e( 'Languages', 'step' ); ?></span>
	...
	<header id="site_header" class="site-header" role="banner">
		...
		<div class="frame">
			...
			<div class="bit md-4">
				<span class="screen-reader-text"><?php _e( 'Social menu', 'step' ); ?></span>
	...
	<nav id="site_nav" class="site-nav">
		<span class="screen-reader-text"><?php _e( 'Primary menu', 'step' ); ?></span>
		
		
		<button id="menu-trigger" class="menu-toggle"><span class="fa fa-bars" aria-hidden="true"></span> <?php echo esc_html(__('Menu', 'step')); ?></button>
