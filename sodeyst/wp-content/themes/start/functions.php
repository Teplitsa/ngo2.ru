...
function bb_setup() {
	...
	// Inits
	load_theme_textdomain( 'bb', get_template_directory() . '/lang' );
//	add_theme_support( 'automatic-feed-links' );	
	...
	register_nav_menus(array(
		'primary'      => __('Primary Menu', 'bb'),
		'secondary'    => __('Secondary Menu', 'bb'),
		'footer_left'  => __('Left Menu in footer', 'bb'),
		'footer_right' => __('Right Menu in footer', 'bb'),
		'social'       => __('Social Buttons', 'bb'),
		'langs'        => __('Languages', 'bb')
	));
...
function bb_scripts() {
	...
	$style_dependencies[] = 'bb-fontawesome';
	...
	$script_dependencies[] = 'bb-imageloaded';
...
function bb_admin_scripts() {
	...
	wp_enqueue_style('bb-admin', get_template_directory_uri().'/css/admin.css', array());
