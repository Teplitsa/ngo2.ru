...
function tst_event_meta($cpost = null) {
	...
	if(!empty($date)){
		...
		echo "<span class='label'><i class='fa fa-calendar fa-fw'></i><span>".__('Date', 'tst').":</span></span>";
		echo "<time class='value e-date'>".date('d.m.Y', strtotime($date))."</time>";
		echo "</div>";
	}
	if(!empty($time)){
		echo "<div class='em-field'>";
		echo "<span class='label'><i class='fa fa-clock-o fa-fw'></i><span>".__('Time', 'tst').":</span></span>";
		echo "<time class='value e-time'>".apply_filters('tst_the_title', $time)."</time>";
		echo "</div>";
	}
	if(!empty($addr)){
		echo "<div class='em-field'>";
		echo "<span class='label'><i class='fa fa-map-marker fa-fw'></i><span>".__('Address', 'tst').":</span></span>";
